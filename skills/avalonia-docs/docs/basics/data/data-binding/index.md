...
![](../../../../static/img/basics/data-binding/data-binding-overview.png)
...
> [!NOTE]
> For more information about how to use the MVVM Pattern with Avalonia, see the concept page [here](../../../concepts/the-mvvm-pattern/index.md).
