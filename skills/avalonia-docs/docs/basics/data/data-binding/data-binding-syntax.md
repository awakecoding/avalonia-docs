...
![](../../../../static/img/basics/data-binding/data-binding-syntax/data-binding-mode.png)
...
> [!NOTE]
> For more details on how to bind to controls, see [here](../../../guides/data-binding/binding-to-controls.md)
...
> binding. This allows visual customization of each segment. See the example [here](../../../reference/controls/textblock.md#run)
...
> [!NOTE]
> For guidance on how to create a custom converter, see [here](../../../guides/data-binding/how-to-create-a-custom-data-binding-converter.md).
...
![](../../../../static/img/basics/data-binding/data-binding-syntax/targetnullvalue.gif)

## UpdateSourceTrigger (Avalonia 11.1+)
...
![](../../../../static/img/basics/data-binding/data-binding-syntax/updatesourcetrigger.gif)
