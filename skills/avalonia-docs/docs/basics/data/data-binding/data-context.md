...
![](../../../../static/img/basics/data-binding/data-context/data-context-overview.png)
...
![](../../../../static/img/basics/data-binding/data-context/data-context-tree-search.png)
...
> [!NOTE]
> For information about the control trees in Avalonia, and how to see them at run-time, see [here](../../../concepts/control-trees.md).
...
![](../../../../static/img/basics/data-binding/data-context/data-context-greeting.png)

## Design Data Context

You may have noticed, after you first compiled this project, that the preview pane also shows the greeting.

![](../../../../static/img/basics/data-binding/data-context/data-context-previewer.png)
...
> [!NOTE]
> Further discussion of data binding requires you to have a background in the MVVM pattern of programming. For an introduction to the concepts of the MVVM pattern, see [here](../../../concepts/the-mvvm-pattern/index.md).
