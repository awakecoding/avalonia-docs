...
In Avalonia, themes are complete sets of [control themes](../control-themes.md) and [theme resources](../../../../guides/styles-and-resources/how-to-use-theme-variants.md) for built-in controls.
...
- [Fluent Theme](fluent.md) is a modern theme inspired by [Microsoft's Fluent Design System](https://en.wikipedia.org/wiki/Fluent_Design_System).

### Simple theme

- [Simple Theme](simple.md) is an minimal and lightweight theme with limited built-in styling.
