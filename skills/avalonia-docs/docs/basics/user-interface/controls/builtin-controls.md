...
|Control|Description|
|:----|:----|
|[DataGrid](../../../reference/controls/datagrid/README.md)|Displays data in a customizable grid.|
...
|[Calendar](../../../reference/controls/calendar/README.md)|DateTime|The calendar is a control for users to select dates or date ranges.|
...
|[ColorPicker](../../../reference/controls/colorpicker/README.md)|Color / HsvColor|The color picker supports user-selection and editing of colors using a spectrum, palette and component sliders. It also supports an optional alpha component, RGB or HSV color models and hexadecimal color values.|
