...
- [Button Control Documentation](../../../reference/controls/buttons/button.md)
- [TextBox Control Documentation](../../../reference/controls/textbox.md)
- [Label Control Documentation](../../../reference/controls/label.md)
- [Checkbox Control Documentation](../../../reference/controls/checkbox.md)
- [Slider Control Documentation](../../../reference/controls/slider.md)
- [ListBox Control Documentation](../../../reference/controls/listbox.md)
...
> [!NOTE]
> These classifications are somewhat related to the discussion in [Choosing A Custom Control Type](creating-controls/choosing-a-custom-control-type.md).
...
_Avalonia UI_ never provides `UserControl`s by itself as these are not considered general-purpose. For more information on creating and using `UserControl`s in your app see [Choosing A Custom Control Type](creating-controls/choosing-a-custom-control-type.md).
...
In Avalonia, you have the flexibility to create custom controls of all types tailored to your application's specific requirements. See the [Creating Controls](creating-controls/index.md) section for more information
