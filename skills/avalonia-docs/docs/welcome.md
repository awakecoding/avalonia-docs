...
> [!NOTE]
> Get started [here](get-started/index.md).
...
> [!NOTE]
> Get started [here](basics/index.md).
...
> [!NOTE]
> Get the guides for practical advice [here](guides/index.md).
...
> [!NOTE]
> Explore the advanced Avalonia concepts [here](concepts/index.md).
...
> [!NOTE]
> See our WPF migration guide [here](get-started/wpf/index.md).
...
> [!NOTE]
> See our reference section [here](reference/index.md).
