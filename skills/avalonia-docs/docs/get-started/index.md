...
### Rider
	...
	![A screenshot displaying how to download the AvaloniaRider extension in Rider.](../../static/img/get-started/download-rider-avaloniarider.png)

	For more information on using the XAML previewer, see the page on [XAML previewers](xaml-previewers.md).
...
![A screenshot of the default Avalonia app running in a window.](../../static/img/get-started/welcome-to-avalonia.png)
...
Or, for a short tutorial building a simple app that introduces you to basic concepts and functions in Avalonia, proceed to the next page:
  ...
  [Starter tutorial: Build a temperature converter app →](starter-tutorial/index.md)
