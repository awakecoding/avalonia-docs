...
As [mentioned earlier](index.md), the Avalonia window is where your app will run on the target platform. In a .axaml file, the `<Window>...</Window>` tag defines what goes in the window.
