...
1. In the code-behind file **MainWindow.axaml.cs**, locate the `Button_OnClick` event handler that you [created earlier](establishing-events-and-responses.md).
...
3. Run the app again, in [debug mode if required by your IDE](establishing-events-and-responses.md).
...
1. In the code-behind file **MainWindow.axaml.cs**, locate the `Button_OnClick` event handler you [created earlier](establishing-events-and-responses.md).
