...
![](../../../static/img/guides/implementation-guides/mvvm-architecture.png)
...
> [!NOTE]
> For details of how to program _Avalonia UI_ with the code-behind pattern, see [here](../../basics/user-interface/code-behind.md).
