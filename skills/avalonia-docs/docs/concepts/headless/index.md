...
- [Headless Testing with XUnit](headless-xunit.md)
- [Headless Testing with NUnit](headless-nunit.md)
- If you are using another platform or need more control: [Manual setup of the Headless platform](headless-custom.md)
