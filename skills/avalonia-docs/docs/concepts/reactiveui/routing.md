...
If we need to handle view model activation and deactivation, then we add a call to WhenActivated to the view. Generally, a rule of thumb is to always add WhenActivated to your views, see [Activation](view-activation.md) docs for more info.
...
![](../../../static/img/concepts/reactiveui/reactiveui-routing.gif)
