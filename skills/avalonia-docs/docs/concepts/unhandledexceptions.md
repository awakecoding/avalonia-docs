...
If you are using Avalonia together with [ReactiveUI](the-mvvm-pattern/avalonia-ui-and-mvvm.md#reactiveui), you can subscribe to their `RxApp.DefaultExceptionHandler`. For more information please refer to [ReactiveUI Default Exception Handler](https://www.reactiveui.net/docs/handbook/default-exception-handler/).
