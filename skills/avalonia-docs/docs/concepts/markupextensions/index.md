...
|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|
| [StaticResource](../../guides/styles-and-resources/resources.md#static-resource)                    | An existing keyed resource and does not update on changes          |
| [DynamicResource](../../guides/styles-and-resources/resources.md#using-resources)                   | Deferred loading of a keyed resource that will update on changes   |
| Binding                                                                                          | Based on the default binding preference: Compiled or Reflection    |
| [CompiledBinding](../../basics/data/data-binding/compiled-bindings.md#compiledbinding-markup)       | Based on a compiled binding                                        |
| [ReflectionBinding](../../basics/data/data-binding/compiled-bindings.md#reflectionbinding-markup)   | Based on a reflection binding                                      |
| [TemplateBinding](../../guides/custom-controls/how-to-create-templated-controls.md#data-binding)    | Based on a simplified binding used only within a `ControlTemplate` |
| [OnPlatform](../../guides/platforms/platform-specific-code/xaml.md#onplatform-markup-extension)     | Conditionally when on the specified platform                       |
| [OnFormFactor](../../guides/platforms/platform-specific-code/xaml.md#onformfactor-markup-extension) | Conditionally when on the specified factor                         |
