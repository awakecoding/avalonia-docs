...
Gets the platform's [Clipboard](services/clipboard.md) implementation.
...
Gets [focus manager](services/focus-manager.md) of the root.
...
Gets the platform's [InsetsManager](services/insets-manager.md) implementation.
...
Represents a contract for accessing top-level [platform-specific settings](services/platform-settings.md).
...
[File System storage](services/storage-provider/index.md) service used for file pickers and bookmarks.
