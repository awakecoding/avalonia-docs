...
> [!WARNING]
> DO NOT use Path property to preserve access to the file or folder. Instead see [Bookmarks](bookmarks.md) page on how to keep access to the storage items.
>
...
> [!NOTE]
> If you want to save file path to reuse it later (in combination with TryGetFileFromPathAsync), please consider using [Bookmarks](bookmarks.md) instead as they are designed to work in sandboxed environment, where user app might not have direct access to the physical file system.
