...
![A screenshot of an IDE, displaying a long line of text in a box that is abruptly cut off.](../../../static/img/reference/properties/texttrimming/texttrimming-none.png)
...
![A screenshot of an IDE, displaying a long line of text in a box that is cut off after a character, with an ellipsis added.](../../../static/img/reference/properties/texttrimming/texttrimming-characterellipsis.png)
...
![A screenshot of an IDE, displaying a long line of text in a box that is cut off after a complete word, with an ellipsis added.](../../../static/img/reference/properties/texttrimming/texttrimming-wordellipsis.png)
...
![A screenshot of an IDE, displaying a long line of text in a box that is cut off in the middle, with an ellipsis placed between the starting and ending characters.](../../../static/img/reference/properties/texttrimming/texttrimming-prefixcharacterellipsis.png)
...
![A screenshot of an IDE, displaying a long line of text in a box that is cut off at the start, with an ellipsis replacing the starting characters and the ending characters visible.](../../../static/img/reference/properties/texttrimming/texttrimming-leadingcharacterellipsis.png)
...
![A screenshot of an IDE, displaying a long line of text in a box that wraps within the box for three lines, before being cut off with an ellipsis added.](../../../static/img/reference/properties/texttrimming/textwrapping-with-texttrimming.png)
