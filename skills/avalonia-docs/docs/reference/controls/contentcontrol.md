...
> Note: The following examples assume an instance of `MainWindowViewModel` is assigned to the Window's `DataContext`. See [the section on `DataContext`](../../basics/data/data-binding/data-context.md) for more information.
...
![Student first and last name](../../../static/img/reference/controls/contentcontrol/contentcontrol-student.png)
