...
> [!WARNING]
> `TreeDataGrid` is maintained as part of Avalonia Accelerate as of October 2025. See the [Accelerate documentation for TreeDataGrid](../../../../accelerate/components/treedatagrid/quickstart.md).

See the reference pages for more information on the [tree view control](../treeview-1.md) and the [data grid control](../datagrid/README.md).
...
![](../../../../static/img/reference/controls/treedatagrid/treedataggrid-files.png)

## Flat Data

This is an illustration An example of  a tree data grid displaying flat data:

![](../../../../static/img/reference/controls/treedatagrid/treedataggrid-countries.png)
...
![](../../../../static/img/reference/controls/treedatagrid/treedataggrid-nuget.png)
