...
> [!WARNING]
> `TreeDataGrid` is maintained as part of Avalonia Accelerate as of October 2025. See the [Accelerate documentation for flat `TreeDataGrid`](../../../../accelerate/components/treedatagrid/quickstart-flat.md).
...
![](../../../../static/img/reference/controls/treedatagrid/treedatagrid-flat.gif)
