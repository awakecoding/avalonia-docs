...
> [!WARNING]
> `TreeDataGrid` is maintained as part of Avalonia Accelerate as of October 2025. See the [Accelerate documentation for hierarchical `TreeDataGrid`](../../../../accelerate/components/treedatagrid/quickstart-hierarchical.md).
...
![](../../../../static/img/reference/controls/treedatagrid/treedatagrid-hierarchical.gif)
