...
> [!WARNING]
> `TreeDataGrid` is maintained as part of Avalonia Accelerate as of October 2025. See the [Accelerate documentation for `TreeDataGrid` column types](../../../../accelerate/components/treedatagrid/column-types.md).
