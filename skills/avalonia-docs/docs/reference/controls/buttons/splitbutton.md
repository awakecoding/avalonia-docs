...
The `SplitButton` functions as a [`Button`](button.md) with primary and secondary parts that can each be pressed separately. The primary part behaves like normal `Button` and the secondary part opens a [`Flyout`](../flyouts.md) with additional actions.
...
![](../../../../static/img/reference/controls/buttons/splitbutton-closed.png)

_SplitButton (Flyout closed)_

![](../../../../static/img/reference/controls/buttons/splitbutton-opened.png)
...
![](../../../../static/img/reference/controls/buttons/splitbutton-palette-flyout.png)
...
![](../../../../static/img/reference/controls/buttons/splitbutton-export.png)
