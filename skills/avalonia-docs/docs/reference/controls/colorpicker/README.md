...
<table>
  ...
  <tr>
    <td>
      ![Fluent Color Palette](../../../../static/img/reference/controls/colorpicker/color-palette-fluent.png)
    </td>
    <td>Contains the Fluent color palette found in Windows 10 and later. This is the default color palette.</td>
  </tr>
  <tr>
    <td>
      ![Flat UI Color Palette](../../../../static/img/reference/controls/colorpicker/color-palette-flat.png)
    </td>
    <td>Contains the full <a href="https://github.com/designmodo/Flat-UI">Flat UI color palette</a>.</td>
  </tr>
  <tr>
    <td>
      ![Flat UI Half Color Palette](../../../../static/img/reference/controls/colorpicker/color-palette-flat-half.png)
    </td>
  ...
  <tr>
    <td>
      ![Material Color Palette](../../../../static/img/reference/controls/colorpicker/color-palette-material.png)
    </td>
  ...
  <tr>
    <td>
      ![Material Half Color Palette](../../../../static/img/reference/controls/colorpicker/color-palette-material-half.png)
    </td>
  ...
  <tr>
    <td>
      ![Sixteen Color Palette](../../../../static/img/reference/controls/colorpicker/color-palette-sixteen.png)
    </td>
