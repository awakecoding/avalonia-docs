...
> [!NOTE]
> To review the concept behind the **data context**, see [here](../../../basics/data/data-binding/data-context.md).
...
![](../../../../static/img/reference/controls/datagrid/datagrid-nuget.png)
...
![](../../../../static/img/reference/controls/datagrid/datagrid-sort-column.gif)

> [!NOTE]
> These examples use the MVVM pattern with data binding to an `ObservableCollection`. For more information on the concepts behind data binding, see [here](../../../basics/data/data-binding/index.md).
...
![](../../../../static/img/reference/controls/datagrid/datagrid-reorder-column.gif)
...
![](../../../../static/img/reference/controls/datagrid/datagrid-column-types.gif)
