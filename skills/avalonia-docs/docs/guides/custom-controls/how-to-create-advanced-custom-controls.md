...
[Attached properties](../../concepts/attached-property.md) are defined almost identically to styled properties except that they are registered using the `RegisterAttached` method and their accessors are defined as static methods.
...
* You can add [data validation](../development-guides/data-validation.md) support
