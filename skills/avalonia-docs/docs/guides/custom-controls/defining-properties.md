...
> [!NOTE]
> For more information about how to use styles in _Avalonia UI_, see the guide [here](../../basics/user-interface/styling/index.md).
...
![](../../../static/img/guides/custom-controls/defining-property-preview.png)
