...
> [!NOTE]
> To review the concept behind the MVVM implementation pattern, see [here](../../concepts/the-mvvm-pattern/index.md).
...
![](../../../static/img/guides/data-binding/bind-reactivecommand.gif)
