...
![](../../../static/img/guides/implementation-guides/devtools-overview.png)
...
![](../../../static/img/guides/implementation-guides/devtools-properties.png)
...
![](../../../static/img/guides/implementation-guides/devtools-layout.png)
...
![](../../../static/img/guides/implementation-guides/devtools-styles.png)

> [!NOTE]
> If given value has a strikethrough it means that it is being overridden by a value in style with higher priority.

![](../../../static/img/guides/implementation-guides/devtools-overridden-styles.png)

Setters have a context menu that allows for quickly copying names and values to the clipboard.

![](../../../static/img/guides/implementation-guides/devtools-setter-contextmenu.png)

## Events

The events tab can be used to track the propagation of [events](../../concepts/input/index.md). Select the events to track in the left pane, and all events of that type will be shown in the center upper pane. Select one of these events to see the event route.
...
![](../../../static/img/guides/implementation-guides/devtools-events.png)
...
![](../../../static/img/guides/implementation-guides/devtools-change-property.gif)

### Changing layout properties

![](../../../static/img/guides/implementation-guides/devtools-change-layout.gif)
