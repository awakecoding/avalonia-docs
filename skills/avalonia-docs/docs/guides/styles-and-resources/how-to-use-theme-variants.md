...
> [!TIP]
> Because theme variants are deeply integrated into resources system, it is important to understand the Avalonia [resources](resources.md) first.
...
![Overriden Theme Variant](../../../static/img/basics/user-interface/styling/overriden-theme-variant.png)
...
![Custom Theme Dictionaries](../../../static/img/basics/user-interface/styling/custom-theme-dictionaries.png)
...
For more details about using resources please follow [How To Use Resources](resources.md) page.
