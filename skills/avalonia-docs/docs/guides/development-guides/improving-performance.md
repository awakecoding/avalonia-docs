...
> [!WARNING]
> [`TreeDataGrid`](../../../accelerate/welcome.md) is maintained as part of Avalonia Accelerate as of October 2025. It is presently still the recommended option for large datasets.
