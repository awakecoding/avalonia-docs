...
- Ensure that you have added a [NuGet.config](getting-started.md#step-2-add-a-nugetconfig) file, **and that it is in the same directory** as the `.sln` file you are loading
...
1. Follow [instructions](advanced/customizing-init.md) on how to setup custom Avalonia initialization.
